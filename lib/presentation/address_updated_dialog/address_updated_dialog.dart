import 'bloc/address_updated_bloc.dart';
import 'models/address_updated_model.dart';
...
class AddressUpdatedDialog extends StatelessWidget {
  const AddressUpdatedDialog({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<AddressUpdatedBloc>(
        create: (context) => AddressUpdatedBloc(
            AddressUpdatedState(addressUpdatedModelObj: AddressUpdatedModel()))
          ..add(AddressUpdatedInitialEvent()),
        child: AddressUpdatedDialog());
  }
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Text("msg_the_address_has".tr, style: theme.textTheme.bodySmall),
